...
=======
                            <input class="form-control" id="validationCustom01" type="text" name ="name" placeholder="Juan Carlos" required title="Nombre de usuario">
                            <div class="font-blue invalid-feedback">
                                Complete este campo
>>>>>>> Stashed changes
                            </div>
                        </div>
...
<<<<<<< Updated upstream
                            ...
                            <div class="font-white invalid-feedback">
                                Ingrese al menos 3 letras
=======
                            <input class="form-control" type="text" id="validationCustom02"  name ="apellido" placeholder="García" required title="Apellido del usuario">
                            <div class="font-blue invalid-feedback">
                                Complete este campo
>>>>>>> Stashed changes
                            </div>
...
=======
                            <input class="form-control" type="email" id="validationCustom03" name ="email" placeholder="mail@mail.com" required title="Email del usuario">
                            <div class="font-blue invalid-feedback">
                                Complete este campo
>>>>>>> Stashed changes
                            </div>
...
=======
                        <label  class="col-sm-3 col-form-label" title="Dni del usuario">DNI*</label>
                        <div class="col-sm-7">
                            <input class="form-control" type="text" id="validationCustom04" name="dni" placeholder="14589657" required title="Dni del usuario">
                            <div class="font-blue invalid-feedback">
                                Complete este campo
>>>>>>> Stashed changes
                            </div>
...
=======
                        <label class="col-sm-3 col-form-label" title="Teléfono del usuario">Teléfono*</label>
                        <div class="col-sm-7">
                            <input class="form-control" type="text" id="validationCustom05" name="telefono" placeholder="221 578 9696 " required title="Teléfono del usuario">
                            <div class="font-blue invalid-feedback">
                                Complete este campo
